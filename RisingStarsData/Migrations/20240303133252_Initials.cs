    ...
    public partial class Initials : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MenteesId = table.Column<string>(type: "text", nullable: false),
                    MentorsMentorId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MentorMentees", x => new { x.MenteesId, x.MentorsMentorId });
                    table.ForeignKey(
                        name: "FK_MentorMentees_AspNetUsers_MenteesId",
                        column: x => x.MenteesId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MentorMentees_Mentors_MentorsMentorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Mentorships", x => new { x.MentorId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_Mentorships_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectMembers", x => new { x.MembersId, x.ProjectsProjectId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSkills", x => new { x.SkillsSkillId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_StudentSkills_AspNetUsers_StudentsId",
                        column: x => x.StudentsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentSkills_Skills_SkillsSkillId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MentorMentees_MentorsMentorId",
                table: "MentorMentees",
